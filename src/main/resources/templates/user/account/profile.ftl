                ...
                <section id="sidebar">
                    ...
                    <aside>
                        <ul class="sidebar-navigation">
                            ...
                            <li><a href="/house/ownlist"><i class="fa fa-home"></i><span>House Own List</span></a></li>
                            <li><a href="/house/bookmarked"><i class="fa fa-heart"></i><span>House Favorite</span></a></li>
                        </ul>
                    </aside>
                </section><!-- /#sidebar -->
            </div><!-- /.col-md-3 -->
                        ...
                        <div class="account-profile">
                            <div class="row">
                                <div class="col-md-3 col-sm-3">
                                    <img alt="Avatar" class="image" src="${(loginUser.avatar)!}">
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <form role="form" id="form-account-password" method="post" action="/accounts/changePassword" >
                                                    ...
                                                    <div class="form-group clearfix">
                                                        <button type="submit" class="btn btn-default" id="form-account-password-submit">Change</button>
                                                    </div><!-- /.form-group -->
