<#macro header>
  ...
  <head>
    ...
    <link rel="stylesheet" href="/static/assets/css/me.css" type="text/css">
         ...
         <div class="container">
           <div class="row">
             <div class="col-md-6 col-sm-6">
               <article>
                 <h3>About</h3>
                 <p> HouseHub is a full-service real estate properties data platform and brokerage that uses modern technology to help people buy and sell homes.
                 </p>
                 <hr>
               </article>
             </div><!-- /.col-sm-3 -->
             <div class="col-md-3 col-sm-3">
               <article>
                 ...
                 <address>
                   ...
                   212 Morning Star Dr<br>
                   San Jose CA 95131
                 </address>
                 +1 (929) 421-5675<br>
                 <a href="#">info@artgeektech.com</a>
               </article>
             </div><!-- /.col-sm-3 -->
             <div class="col-md-3 col-sm-3">
               <article>
                 ...
                 <ul class="list-unstyled list-links">
                   <li><a href="/index">Search House</a></li>
                   <li><a href="/accounts/register">Sign In/Register</a></li>
                 </ul>
               </article>
             </div>
           </div><!-- /.row -->
...
<#macro most_viewed_houses>
<aside id="featured-properties">
  <header><h3>Most Viewed Houses</h3></header>
...
<#macro latest_houses>
<aside id="latest-properties">
  <header><h3>Latest Houses</h3></header>
    <#list latestHouses as house>
    <div class="property small">
      <a href="/house/detail?id=${house.id}">
        <div class="property-image">
          <img alt="" src="${(house.firstImg)!}" style="width: 100px;height: 75px">
...
<aside id="edit-search">
  ...
  <form role="form" id="_searchForm" class="form-search" method="post" action="/house/list">
    ...
    <div class="form-group">
      <input type="text" class="form-control" id="search-box-property-id" value="${(vo.name)!}" name="name" placeholder="Type key words">
    </div>
    <div class="form-group">
      <select name="type">
        <option value="1" >For Sell or For Rent</option>
        <option value="1" <#if (vo.type)?? && (vo.type)==1> selected </#if> >For Sell</option>
     ...
     <div class="container">
       ...
       <div class="user-area">
         <div class="actions">
           <#if (loginUser.name)??>
             <a href="/accounts/profile" class="promoted">Hello, ${(loginUser.name)!}</a>
                <#if (loginUser.email)?? && (loginUser.email) == "marcoshown26@gmail.com">
                  <a href="/agency/create" class="promoted">Create Agency</a>
                </#if>
             <a href="/accounts/logout" class="promoted">Sign Out</a>
           <#else>
         ...
         <div class="language-bar">
           <a href="#" class="enable"><img src="/static/assets/img/flags/gb.png" alt=""></a>
     ...
     <header class="navbar" id="top" role="banner">
       ...
       <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
         <ul class="nav navbar-nav">
           ...
           <li class="has-child"><a href="/house/list">House List</a>
             <ul class="child-navigation">
               <li><a href="/house/list?type=1">Sell</a></li>
       ...
       <div class="add-your-property">
         <a href="/house/toAdd" class="btn btn-default"><i class="fa fa-plus"></i><span class="text">Add House</span></a>
       </div>
     </header><!-- /.navbar -->
   </div><!-- /.container -->
 </div>
  ...
  <ul class="pagination">
     <#list pagination.pages as page>
       <#if pagination.pageNum == page>
         <li class="enable"><a href="">${page}</a></li>
       <#else>
